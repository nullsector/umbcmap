...
public class DBAdapter {
    ...
    public long insertTitle(String room, double longitude, 
    		double latitude, String type) 
    {
    ...
    String title, double longitude, double latitude, String type) 
    {
